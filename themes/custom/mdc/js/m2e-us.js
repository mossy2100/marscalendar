...
var jday = (Math.floor(solsSince*100000)/100000);

var MARS_START = Date.UTC(1609, 02, 11, 18, 40, 46, 400).valueOf();

var	milliseconds = (jday - 128256.2958) * MILLISECONDS_PER_SOL;
var	roundFloorSols = Math.floor((milliseconds - MARS_START) / MILLISECONDS_PER_SOL);


//var nSolofWeek = (roundFloorSols %7 +1);
...

{
	...
	nSolofWeek2 = (roundFloorSols %7 +1);

	switch (nSolofWeek2)
	{
		case 1: return "Phobosol";
		case 2: return "Deimosol";
		case 3: return "Terrasol";
		case 4: return "Venusol";
		case 5: return "Mercurisol";
		case 6: return "Jovisol";
		case 7: return "Sunsol";
	}
}
...
//    }
    ...
    //Darian Sols of the Week
    if (roundFloorSols % 7 + 1 == 1)
    	nSolName = "Phobosol";
    if (roundFloorSols % 7 + 1 == 2)
    	nSolName = "Deimosol";
    if (roundFloorSols % 7 + 1 == 3)
    	nSolName = "Terrasol";
    if (roundFloorSols % 7 + 1 == 4)
    	nSolName = "Venusol";
    if (roundFloorSols % 7 + 1 == 5)
    	nSolName = "Mercurisol";
    if (roundFloorSols % 7 + 1 == 6)
    	nSolName = "Jovisol";
    if (roundFloorSols % 7 + 1 == 7)
    	nSolName = "Sunsol";
    }
